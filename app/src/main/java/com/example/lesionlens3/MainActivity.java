...
//        textView=findViewById(R.id.textView);
                ...
                if (mClassifier != null && mBitmap != null) {
                    try {
                        ...
                        if (result != null) {
                            ...
                            float res = (result.confidence) * 100;
                            String temp = "" + res;
    ...
    public void showWarningDialog() {
        ...
        builder.setTitle("Alert")
                .setMessage("It will give accurate result only for cancerous skin image !")
                ...
                .setNegativeButton("Abort camera", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        // Handle "No" option
                        dialog.dismiss();
